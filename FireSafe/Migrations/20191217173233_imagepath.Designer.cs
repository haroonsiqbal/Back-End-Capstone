...
namespace FireSafe.Migrations
{
    ...
    [Migration("20191217173233_imagepath")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FireSafe.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FireSafe.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("FireSafe.Models.Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FireSafe.Models.Log", b =>
                {
                    b.HasOne("FireSafe.Models.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FireSafe.Models.Seller", "Seller")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FireSafe.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
